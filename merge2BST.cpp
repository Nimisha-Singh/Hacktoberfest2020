...
void inorder1(Node *root1,vector<int> &v){
    if(root1==NULL)
    return;
    inorder1(root1->left,v);
    v.push_back(root1->data);
    inorder1(root1->right,v);
    
}
void inorder2(Node *root2,vector<int> &v){
    if(root2==NULL)
    return;
    inorder2(root2->left,v);
    v.push_back(root2->data);
    inorder2(root2->right,v);
